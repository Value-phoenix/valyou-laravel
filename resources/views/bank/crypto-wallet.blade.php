...
<div class="col-md-12">
        ...
        <div class="row">
            ...
            <div <?php echo
                ...
                <?php } else {?>
                <a href="{{ route('admin.role.switch',['role_id' => 2]) }}" style="color:#A69C9C !important;"> Artist
                    Company Account </a>
                <a href="{{ route('admin.role.switch',['role_id' => 2]) }}" style="color:#A69C9C !important;"> Business
                </a>
                <?php }?>
...
<div class=" mini-stats-wid wallet" style="height: auto; border: none">
    <div class=" mt-5">
        <div class="media-body mb-5 text-center" style= "font-family: 'Roboto',sans-serif; font-style: normal; -webkit-transform: translateZ(0);">
            <h2 id="vxd-price" class="mb-0 <?php echo (check_role()!=1)? 'active': '';?>">$ {{ numberformat($wallet) }}
                VXD</h2>
            <h2 id="artist-price" class="mb-0">$ {{ numberformat($total['artist_total']) }} VXD</h2>
            <h2 id="reserve-price" class="mb-0 <?php echo (check_role()==1)? 'active': '';?>">$
                {{number_format($users_reserve_amount,2)}} VXD</h2>
            <h2 id="circulating-supply-price" class="mb-0">$ {{number_format($users_all_amount,2)}} VXD</h2>
            <h2 id="security-compliance-account-price" class="mb-0">$ 0.00 VXD</h2>
            <h2 id="valyoux-access-token-price" class="mb-0"> {{number_format($access_token,2)}} Tokens</h2>
            <h2 id="investor-price" class="mb-0">$ {{ numberformat($total['investor_total']) }} VXD</h2>
            <h2 id="business-price" class="mb-0">$ {{ numberformat($total['business_total']) }} VXD</h2>
...
<!--                                         <div class="col-xl-2 col-sm-4">
            ...
            <button class="btn btn-dark-pink exchange" onclick="stripePayment()">Deposit / Buy VXD</button>
                ...
                <div id="payment_options" class=" mb-2 p-4 card" style="display:none;font-size: 18px;">
                    ...
                    <div class="paymento">
                        <input class="mx-auto" type="radio" name="payment_type" value="credit_card"
                            ...
                            src="{{asset('assets/images/payment_methods_logos-1.png')}}"> </img> <br>
                        <input class="mx-auto mt-3" type="radio" name="payment_type" value="coin_deposit"
                            ...
                            src="{{asset('assets/images/valyuxusdcPayment.png')}}"> </img>
                ...
                <div id="stripe_payment_div" class="mt-2 mb-2 px-3 py-4 card"
                    ...
                    @endif -->
                        <form role="form" action="{{route('admin.stripe.post')}}" method="post"
                ...
                <div id="crypto_payment_div" style="line-height: normal;display:none;border-radius: 10px;">
                    <div class="mt-2 mb-2 px-3 py-4 card">
                        <div class="panel-body">
                            <form action="{{route('admin.crypto.post')}}" method="post">
                                @csrf
                                <div class='form-row row'>
                ...
                <div id="crypto_payment_sell" style="line-height: normal;display:none;border-radius: 10px;">
                    <div class="mt-2 mb-2 px-3 py-4 card">
                        <div class="panel-body">
                            <form action="{{route('admin.sellVxdCrypto.post')}}" method="post">
                                @csrf
                                <div class='form-row row'>
                                    <div class='col-sm-12 col-md-12 form-group'>
                                    ...
                                    <div class="mt-4">
                                        <div class="table-responsive">
                                            <table id="datatable4"
                                                ...
                                                <tbody>
                                                    <?php   $i = 1; ?>
                                                    @if(count($transactions_data['personal']) > 0)
                                                    @foreach($transactions_data['personal'] as $row)
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable2"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($transactions_data['investor'] as $row)
                                    ...
                                    <div class="mt-4">
                                        <div class="table-responsive">
                                            <table id="datatable4Token"
                                                ...
                                                <tbody>
                                                    <?php   $i = 1; ?>
                                                    @if(count($AccessTokenHistory) > 0)
                                                    @foreach($AccessTokenHistory as $row)
                                                    <tr>
                                                     <td>{{ $i++ }}</td>
                                                     <td>
                                                      <div class="set_display">
                                                      <img src="{{ isset($row['from_user']['avatar']) ? asset($row['from_user']['avatar']) : asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle header-profile-user user-avatar-obj-fit-cover" >&nbsp;
                                                      <p class="set_margin"> {{ $row['from_user']['first_name'] . ' ' .  $row['from_user']->last_name;}}</p></div>
                                        	         </td>
                                                     <td>
                                                      <div class="set_display">
                                                      <img src="{{ isset($row['to_user']['avatar']) ? asset($row['to_user']['avatar']) : asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle header-profile-user user-avatar-obj-fit-cover" >&nbsp;
                                                      <p class="set_margin">{{ $row['to_user']['first_name'] . ' ' .  $row['to_user']->last_name; }}</p>
                                                      </div>
                                        	          </td>
                                                      <td>{{ numberformat($row['access_tokens'])}} Tokens</td>
                                                      <td>$ {{ numberformat($row['access_tokens_current_value']) }} VXD</td>
                                                      <td>{{ numberformat($row['access_tokens_burnt']) }} Tokens</td>
                                                      <td>{{ numberformat($row['access_token_remaining']) }} Tokens </td>
                                                      <td>{{ numberformat($row['access_tokens_required']) }} Tokens</td>
                                                      <td>{{ $notes[$row->desc]['title'] }}</td>
                                                      <td>{{ $row['created_at'] }}</td>
                                    ...
                                    <div class="mt-4">
                                        <div class="table-responsive">
                                            <table id="datatable3"
                                                ...
                                                <tbody>
                                                    <?php   $i = 1; ?>
                                                    @foreach($transactions_data['business'] as $row)
                                                    <tr>
                                                        <td>{{ $i++ }}</td>
                                                        <td>
                                                            <div class="set_display">
    ...
    <script type="text/javascript">
        ...
        $('#nav-valyoux-access-token').click(function () {
            ...
            var access_tokens_amount = {{ number_format($access_token * $settings -> valyoux_access_token_subscription_fee, 2, '.', '')
        }};
        ...
        myFormtoken.addEventListener('submit', (e) => {
            ...
            axios({
                method: 'post',
                url: `{{ route('admin.depositAccessToken') }}`,
                data: formData,
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
