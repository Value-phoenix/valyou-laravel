...
<body>
    ...
    <div class="row logo-div justify-between align-center">
        <div class="col-5 col-lg-3">
            <a href="{{url('/')}}"> <img src="{{asset('assets/images/valyou_x_black_logo.svg')}}" alt=""
                    class="img-fluid logo-img" style="width: 45%"></a>
        </div>
        <div class="mr-5 d-flex gap-2">
            <a class="btn btn-outline-success exchange bg-hoverevent py-2 logbtns" href="{{url('/login')}}" style="border-color: rgb(250, 132, 152);font-size: 15px;color: rgb(250, 132, 152);">Login/sign up</a>
            <a class="btn btn-token-presale exchange text-hoverevent py-2 logbtns" href="{{url('/presell')}}">TOKEN
                PRESALE</a>
            <div>
                <button class="menu-hoverevent py-1 border-none" data-toggle="modal" data-target="#exampleModal" style="padding: 0; height: 10px">
                    <i class="mdi mdi-menu accor-plus-icon menuItem-col" style="font-size: 25px"></i></button>
            </div>
        </div>
    </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="nav flex-sm-column flex-column">
                            <img src="{{asset('assets/images/valyou_x_black_logo.svg')}}" alt="" width="200"
                                height="50">
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer mt-2"
                                href="{{url('/presell')}}">Token Presale</a>
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer"
                                href="{{url('/login')}}">Login / sign up</a>
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer"
                                href="{{url('/')}}">Home</a>
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer"
                                href="{{url('/market')}}">Market</a>
    ...
    <div class="flex h-min-80">
        <div class="px-5 w-full">
            <div class="scrolling-wrapper">
                <div class="scrolling" style="margin-bottom: 40px"> EXCHANGE RATES
                    <span class="pink">:</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="{{ asset('assets/images/valyoux/ethereum_logo_valyou_x_music.svg') }}" width="15"
                        height="15" alt="">&nbsp;&nbsp;1 ETHEREUM (ETH) &nbsp;=&nbsp;
                    <p>0.02776 BTC</p> &nbsp;=&nbsp; $
                    <p>{{ $ETHUSDT ?? '' }} USD</p> &nbsp;&nbsp;
                    <p class="text-green"> + 0.25% </p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="{{ asset('assets/images/valyoux/bitcoinlogo.svg') }}" width="15" height="15">&nbsp;&nbsp;1
                    BITCOIN
                    (BTC) &nbsp;=&nbsp; $
                    <p>{{ $BTCUSDT ?? '' }} USD</p> &nbsp;&nbsp;
                    <p class="text-red"> - 0.15% </p>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="{{ asset('assets/images/valyoux/vuxlogo.svg') }}" width="15" height="15">&nbsp;&nbsp;1
                    Valyou X Dollar
                    (VXD) = &nbsp;&nbsp; $
                    <p>{{ $USDCUSDT ?? '' }} USDC</p> &nbsp;&nbsp;
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 d-flex align-center">
            <div class="p-4">
                <img src="{{asset('assets/images/valyoux_img.jpg')}}" alt="" class="w-full">
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-4 grid-cols-2 place-content-between">
        <div
            ...
            <img src="{{asset('assets/images/download.png')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/alibabacloud_icon.svg')}}" style="height: 70px; width: 130px;">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-1.png')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-3.png')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-5.png')}}" style="height: 70px; width: 130px;">
            <div class=" text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-4.jpg')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-6.png')}}" style="height: 70px; width: 130px;">
            <div class=" text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-7.png')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-8.png')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/fintech_logo.png')}}" style="height: 70px; width: 130px;">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
    </div>
    <div class="mt-13">
        <div class="shadow-ssm d-flex row-reverse py-4 justify-center align-center">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="{{asset('assets/images/download.jpg')}}" alt="" class="w-full rounded">
            </div>
        </div>
    </div>
    <div class="mt-13">
        ...
        <img src="{{asset('assets/images/howitworks.svg')}}" alt="" class="w-full rounded mt-3" width="800"
            height="800">
    </div>
    ...
    <div class="bg-black px-15 d-flex flex-column align-center justify-center mt-5">
        <img src="{{asset('assets/images/logo_white.svg')}}" alt="" class="rounded" width="250" height="80">
