...
<body>
    ...
    <div class="grid gap-4 grid-cols-2 place-content-between">
        ...
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/alibabacloud_icon.svg')}}" style="height: 70">
            <div class="text-xm text-imgdec">Alibaba Group Award Winner</div>
        </div>
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
        ...
        <div
            class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
            <img src="{{asset('assets/images/download-5.png')}}" style="height: 70"">
    ...
    <div
        class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
        <img src="{{asset('assets/images/download-6.png')}}" style="height: 70"">
                    <div class=" text-xm text-imgdec">Alibaba Group Award Winner
    </div>
    </div>
    <div
    ...
    <div
        class="h-130 shadow-ssm p-3 text-xl txt-bold txt-title d-flex gap-3 flex-column w-full  d-flex justify-center align-center">
        <img src="{{asset('assets/images/fintech_logo.png')}}" style="height: 70">
    </div>
    </div>
    <div class="mt-13">
