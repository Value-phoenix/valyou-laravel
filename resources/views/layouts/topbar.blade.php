                ...
                <div class=" topbar-new topbar-new-mob">
                    ...
                    <div class="dropdown" style="padding-right: 5%">
                        ...
                        <div class="dropdown-menu dropdown-menu-right align-left dropnewstuff"
                            ...
                            <!-- <p class="m-0 py-2"><a href="deposit" class="nav-link" >Deposit Balance: $ {{ $wallet }} VXD</a></p> -->
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <p class="m-0 py-1">Total Balance: $ {{ $wallet }} VXD</p>
                        </div>
                    </div>
                                        ...
                                        <div class="simplebar-offset" style="right: -17px; bottom: 0px;">
                                            <div class="simplebar-content-wrapper"
                                                ...
                                                <div class="simplebar-content" style="padding: 0px;">
                                                    <a href="{{ route('admin.role.switch',['role_id' => 2]) }}"
                                                        class="text-reset notification-item">
                                                        <div class="media">
                                                            <div class="avatar-xs mr-3">
                                                                <span class="avatar-title rounded-circle font-size-16">
                                                                    <img src="{{ asset('assets/images/valyoux/artist.svg') }}"
                                                                        alt="{{ asset('assets/images/valyoux/artist.svg') }}"
                                                                        width="16" />
                                                                </span>
                                                            </div>
                                                    ...
                                                    <a href="{{ route('admin.role.switch',['role_id' => 4]) }}"
                                                        class="text-reset notification-item">
                                                        <div class="media">
                                                            <div class="avatar-xs mr-3">
                                                                <span class="avatar-title rounded-circle font-size-16">
                                                                    <img src="{{ asset('assets/images/valyoux/business.svg') }}"
                                                                        alt="{{ asset('assets/images/valyoux/business.svg') }}"
                                                                        width="16" />
                                                                </span>
                                                            </div>
                                                            <div class="media-body">
                                                    ...
                                                    <a href="{{ route('admin.role.switch',['role_id' => 3]) }}"
                                                        class="text-reset notification-item">
                                                        <div class="media">
                                                            <div class="avatar-xs mr-3">
                                                                <span class="avatar-title rounded-circle font-size-16">
                                                                    <img src="{{ asset('assets/images/valyoux/investor.svg') }}"
                                                                        alt="{{ asset('assets/images/valyoux/investor.svg') }}"
                                                                        width="16" />
                                                                </span>
                                                            </div>
                                                            <div class="media-body">
                                                    ...
                                                    @if($user->is_admin)
                                                    <a href="{{ route('admin.role.switch',['role_id' => 1]) }}"
                                                        class="text-reset notification-item">
                                                        <div class="media">
                                                            <div class="avatar-xs mr-3">
                                                                <span class="avatar-title rounded-circle font-size-16">
                                                                    <img src="{{ asset('assets/images/valyoux/accountSwitch.svg') }}"
                                                                        alt="{{ asset('assets/images/valyoux/accountSwitch.svg') }}"
                                                                        width="16" />
                                                                </span>
                                                            </div>
                                                            <div class="media-body">
                    ...
                    <div class="dropdown d-inline-block">
                        <a href="{{ $url }}" class="btn header-item waves-effect">
                            <img class="rounded-circle header-profile-user user-avatar-obj-fit-cover"
                                src="{{ $user_image }}" alt="Header Avatar">
                    ...
                    <ul class="navbar-nav top-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                ...
                                href="{{ url('account-balance') }}">Bank</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px"
                                href="{{ route('admin.social-media') }}">Social Media</a>
                        </li>
                        {{-- <li class="nav-item">
                            <a href="{{ url('connect') }}" class="nav-link">Connect</a>
                        </li> --}}
                        <li class="nav-item">
                            <a href="{{ route('admin.watch') }}" class="nav-link"
                                style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px">Watch
                                & Earn</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.listenandearn') }}" class="nav-link"
                                ...
                                <div class="simplebar-wrapper" style="margin: 0px;">
                                    ...
                                    <div class="simplebar-mask">
                                        <div class="simplebar-offset" style="right: -17px; bottom: 0px;">
                                            ...
                                            ?>
                                                    <a href="" class="text-reset notification-item  {{ $class }}">
                                                        <div class="media">
                                                            <img class="mr-3 rounded-circle avatar-xs"
                                                                src="{{ asset($row['from_user']['avatar']) }}"
                                                                alt="{{ asset('assets/images/valyoux/artist.svg') }}"
                                                                width="16" />
                                                            <div class="media-body">
                                                                <div class="font-size-12 text-muted">
                                                                    <p class="notification_text">{{
                                                                        $row->notification_text }}</p>
                                                                    <?php if($row->status == 0){ ?>
                                                                    <img class="notification_image"
                                                                        src="{{ URL::asset('/assets/images/valyoux/message icon.svg') }}"
                                                                        width="20">
                                                                    <?php  }else{ ?>
                                                                    <img class="notification_image"
                                                                        src="{{ URL::asset('/assets/images/valyoux/open.svg') }}"
                                                                        width="20">
                                                                    <?php }?>
                                                                </div>
                                                            </div>
