            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ url('artist/artist/edit/'.$artists['id']) }}">Profile Settings</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <!-- <li><a href="{{ url('valyou-playlist') }}">Watch & Earn</a></li> -->
                    </ul>
                </li>
                <hr>
                @endcan
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ url('market') }}">America (North)</a></li>
                        <li><a href="{{ url('market') }}">Africa</a></li>
                        <li><a href="{{ url('market') }}">South America</a></li>
                        <li><a href="{{ url('market') }}">Asia</a></li>
                        <li><a href="{{ url('market') }}">Australia</a></li>
                        <li><a href="{{ url('market') }}">Europe</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ url('artist/stock-price/26') }}">Buy Valyou X (Tokens)</a></li>
                        <li><a href="{{ url('investment-portfolio') }}">Investment Portfolio</a></li>
                        @if ($user->roles->contains(1))
                        <li><a href="{{ url('vxd-orders') }}">VXD Orders</a></li>
                        @endif
                        <!--                         <li><a href="{{ url('crypto-kyc-application') }}">@lang('translation.KYC_Application')</a></li> -->
                        @if ($user->roles->contains(1))
                        <li><a href="{{ url('stripe') }}">Stripe Payment</a></li>
                        @endif
                    </ul>
                </li>
                <li class="mb-3">
                    <!-- <a href="{{ route('admin.social-media') }}">
                        ...
                        src="{{ asset('assets/images/valyoux/social_media_valyoux_new1.svg') }}">
                ...
                <li class="mb-3">
                    <!-- <a href="{{ route('admin.watch') }}">
                        <img class="mr-9" width="25"
                        src="{{ asset('assets/images/valyoux/eye1.svg') }}">
                        <span>Watch</span>
                    </a> -->
                    <a href="{{ route('admin.watch') }}">
                        <img class="mr-9 fix-sidebar-icon" width="16"
                            src="{{ asset('assets/images/valyoux/eye.svg') }}">
                ...
                <li >
                    ...
                    {{-- <ul class="sub-menu" aria-expanded="false">
                        <li><a href="expression-interest">Expression of Interest</a></li>
                        <li><a href="form-validation">Get Signed</a></li>
                        <li><a href="upcoming-artist">Upcoming Artist</a></li>
                        <li><a href="{{ route('admin.user.profile', auth()->user()->id) }}">Professional Artist</a>
                        </li>
                        <li><a href="independent-major-artist">Independent Major Artist</a></li>
                        <li><a href="major-label-artist">Major Label Artist</a></li>
                    </ul> --}}
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="products">@lang('translation.Products')</a></li>
                        <li><a href="product-detail">@lang('translation.Product_Detail')</a></li>
                        <li><a href="orders">@lang('translation.Orders')</a></li>
                        <li><a href="customers">@lang('translation.Customers')</a></li>
                        <li><a href="cart">@lang('translation.Cart')</a></li>
                        <li><a href="checkout">@lang('translation.Checkout')</a></li>
                        <li><a href="shops">@lang('translation.Shops')</a></li>
                        <li><a href="add-product">@lang('translation.Add_Product')</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="starter">@lang('translation.Starter_Page')</a></li>
                        <li><a href="maintenance">@lang('translation.Maintenance')</a></li>
                        <li><a href="timeline">@lang('translation.Timeline')</a></li>
                        <li><a href="faqs">@lang('translation.FAQs')</a></li>
                        <li><a href="pricing">@lang('translation.Pricing')</a></li>
                    </ul>
                </li>
                <li class="mb-3">
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="create-tasks">@lang('translation.Create_Task')</a></li>
                    </ul>
                </li> --}}
                @endcan
                <li class="mb-3">
