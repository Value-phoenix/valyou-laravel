...
<!-- General Play Video??? -->
@if(isset($item->artist['id']))
<div class="social-post {{$item->id}}">
    <div class="card margin-n">
        <div class="post-section card-body">
                ...
                <div class="col-lg-12 col-12">
                    <div class="row">
                        <div class="col-lg-9 col-9 profile_img_name">
                            <a href="artist/posts/{{$item->artist['id'] }}">
                                <img class="img-change rounded-circle mr-2" src="{{ URL::asset($item->artist->photo ?? '') }}" alt="">
                            </a>
                            <!--</div>-->
                            ...
                            <div class="inner_img_name">
                                ...
                                <p class="post-section-artist-p2 light-gray-color">{{ $item->artist['about'] }} <i class="fa fa-globe" aria-hidden="true"></i></p>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-12 padding-n mt-3">
                @if ($item->type == 1)
                    <p class="post-section-para">{{ $item->description ?? '' }}</p>
                @else
                    <a href="socialmedia/details/{{$item->id}}">
                        <p class="post-section-para">{{ $item->description ?? '' }}</p>
                    </a>
                @endif
            </div>
            <div class="col-lg-12 col-12 padding-n parent-for-video">
                @if ($item->type == 1)
                    @if (isset($item->audio_cover_image))
                        <div class="" style="display: flex;align-items:center;">
                            <img class="audio-cover-image" src="{{ asset($item->audio_cover_image) }}">
                            <p class="post-section-para audio-text">
                                {{ $item->audio_title ?? '' }} <span>{{ $item->singer ?? '' }}, {{ $item->music_by ?? '' }}, {{ $item->starcast ?? '' }}
                                    <!-- <a href="socialmedia/details/{{$item->id}}">View More Details</a></span> -->
                            </p>
                        </div>
                        <br>
                @endif
                    <audio controlsList="nodownload" class="overlay-for-audio" style="width: 100%;" controls="" data-video="{{ $checkvideo }}" data-brand="{{ $item->artist->brand }}" data-videoid="{{ $item->id }}" data-userid="{{ $item->artist['id'] }}">
                        <source src="{{ asset($item->name) }}" type="audio/mpeg">
                    </audio>
                @else
                    @php
                ...
                @if ($item->audio_cover_image)
                    <img src="{{ asset($item->audio_cover_image) }}" class="alternative-cover-image" alt="">
                @else
                    <video controlsList="nodownload" id="video{{ $item->id }}" src="{{ asset($item->name) }}" data-video="{{ $item->artist->brand }}" class="video" type="video/mp4" controls playsinline></video>
                @endif
                    <div class="overlay-for-video" id="overlay{{ $item->id }}" data-video="{{ $checkvideo}}" data-videoid="{{ $item->id }}" data-brand="{{ $item->artist->brand }}" data-userid="{{ $item->artist['id'] }}">
        ...
        <div class="col-lg-12">
            ...
            <div class="social-media-profile-wrap">
                <div class="sm-left-wrap">
                    <img src="{{ URL::asset($item->artist->photo ?? '') }}" alt="" class="avatar-md avatar-md-cover rounded-circle">
                    <div class="sm-left-desc for_web">
                        <h2>{{ isset($item->artist->brand) ? $item->artist->brand : ''; }} </h2>
                        <p class="mb-2"><i class="fa fa-clock-o" aria-hidden="true"></i>{{ isset($item->artist->about) ? $item->artist->about : ''; }}</p>
                        <h5>Artist share price: <span class="color-white">${{ numberformat(@$item->artist->stock_value) }} VXD </span>
                            @if ($item->artist->change_stock > 0)
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                <span class="text-green">+ {{ numberformat(@$item->artist->change_stock) }}%</span>
                        </h5>
                            @else
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/pink_arrow_circle_down.svg') }}">
                                <span class="text-danger">{{ signFormat(@$item->artist->change_stock,0) }}%</span></h5>
                        @endif

                    </div>
                    <div class="sm-left-desc for_mob">
                        <h2>{{ isset($item->artist->brand) ? $item->artist->brand : ''; }}</h2>
                        <p><i class="fa fa-clock-o" aria-hidden="true"></i> {{ isset($item->artist->about) ? $item->artist->about : ''; }}</p>
                        <h5>Artist share price: <span class="color-white">${{ numberformat(@$item->artist->stock_value) }} VXD </span>
                            @if ($item->artist->change_stock > 0)
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                <span class="text-green">+ {{ numberformat(@$item->artist->change_stock) }}%</span>
                ...
                <div class="sm-right-wrap">
                    <button type="button" class="btn-invest-pink-grad" onclick="location.href='artist/profile/{{ isset($item->artist->id) ? $item->artist->id : ''; }}'"> Invest in
                        Artist</button>
                </div>
            </div>
        </div>
    </div>
    <div style="display: none;" id="valyou-music-section-{{ $item->id }}" class="valyou-media">
        ...
        <div class="container">
            ...
            <div class="container col-md-12 text-center mb-5 proceed-valyou-song-div">
                ...
                <button type="button" class="btn valyou-g-btn add_value spycust-margin-10" value="{{$item->id}}">Proceed to Valyou Song</button>
                <button type="button" class="btn valyou-close-btn spycust-margin-10" value="{{$item->id}}">Cancel</button>
    ...
    <div class="container mb-3 mt-3 added-feature">
        <div class="row ">
            ...
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-comments" data-commentid="{{ $item->id }}">
                    <div class="card-body body-p">
            ...
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-promote-song" data-promoteid="{{ $item->id }}">
                    <div class="card-body body-p">
    ...
    <div style="display: none" class="mt-3" id="comments-section-{{ $item->id }}">
                        ...
                        <li id="comment_{{$comment->id}}">
                            ...
                            <div class="row">
                                <div class="col-12 single-comment">
                                    <img src="{{ URL::asset(\App\User::find($comment->user_id)->avatar) }}" alt="" class="avatar-md avatar-md-cover rounded-circle sc-img img-fluid">
                                    <div class="sc-inner">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-8 mt-3 mt-0-mobile col-8 pad-left-0">
                            <div class="position-relative spycustcomment" >
                                <input type="text" class="form-control chat-input" name="comment-{{$item->id}}" placeholder="Enter Comment...">
                            </div>
                        </div>

                        <div class="col-md-2 col-2 spycustcomment">

                            <img style="transform: rotate(90deg);" class="mr-3 comment-btn" data-media="{{$item->id}}" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form method="post" action="{{ url('promotevideo/'.$item->id) }}" id="promotevideo-form-{{ $item->id }}">
        @csrf
        <div style="display: none" id="promote-song-section-{{ $item->id }}">
            <div class="container">
                <!-- Set Promotion Budget -->
                <div class="row card">
                    <div class="modal-header">
                        <h5 class="modal-title">Invite your friends, new fans & potential investors to listen to your song</h5>
                        <button type="button" class="btn-close close-btn-promote-song-section" data-bs-dismiss="modal" data-promoteid="{{ $item->id }}" aria-label="Close"></button>
                    </div>
                    <div class="card-body price-card mb-5 text-center">
                        ...
                        <div class="quantity">
                            ...
                            <input type='text' id="quantity{{$item->id}}" name='quantity' value='50' class='qty input-qty dollar' />
                    ...
                    <div class="col-md-12 text-center mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <span class="input-qty pt-3"></span>
                                <input type='text' id="quantity2{{$item->id}}" name='quantity2' value='2' class='qty input-qty pt-3' />
                    ...
                    <div class="mb-3">
                        <div id="valyoux{{$item->id}}" class="col-12 valyoux users-list">
                            <h2 class="fw-600">Investors on Valyou X </h2>
                            <input name='investor-list'id="investorlist{{$item->id}}" value='abatisse2@nih.gov, Justinian Hattersley'  class='tagify--outside'>
                        </div>
                        <!-- <div id="email{{$item->id}}" class="col-12 email">
                            <h2 class="fw-600">Promote via Email</h2>
                            <input id="promoteemail{{$item->id}}" type="text" data-role="tagsinput" placeholder="Please enter Multi Emails using  , " class="form-control" />
                        </div> -->
                        <!-- <div id="phone{{$item->id}}" class="col-12 phone">
                            <h2 class="fw-600">Promote Via SMS</h2>
                            <input id="promotephone{{$item->id}}" class="form-control number-input-music" placeholder="Please enter Multi Phone Numbers using  , " type="number" data-role="tagsinput">
                        </div> -->
                        
                        <div id="email{{$item->id}}" class="col-12">
                            <h2 class="fw-600">Promote via Email</h2>
                            <input name='email-promote' id="promoteemail{{$item->id}}" class='tagify--outside' placeholder='Please enter Multi Emails'>
                        </div>

                        <div id="email{{$item->id}}" class="col-12">
                            <h2 class="fw-600">Promote via SMS</h2>
                            <input id="phone{{$item->id}}" type="tel" name="phone-promote" data-id="{{$item->id}}" class="form-control" />
                            <div class="mb-2"></div>
                            <input name='sms-promote' id="promotephone{{$item->id}}" class='tagify--outside tagify--outside-sms' placeholder='Please enter Multi SMS'>
                        </div>
                     </div>
                    <div class="col-md-12 mb-2">
                        <button type="button" class="btn post-now-btn float-right mb-3 promote-btn-{{ $item->id }}" onclick="promoteVideo('{{ $item->id }}')"> Promote </button>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-12 text-center image_wrapper">
                <div class="image__innerwrapper">
                    ...
                    <div class="video_wrapper">
                        ...
                        <!--<video id="video{{ $item->id }}" src="{{ asset($item->name) }}" class="video" type="video/mp4" controls playsinline></video>-->
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-12 mb-3">
...
<div class="social-post {{$item->song_id}}">
        ...
        <div class="post-section card-body">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="row">
                        <div class="col-lg-9 col-9 profile_img_name">
                            <a href="artist/posts/{{ $item->artist_id }}">
                                <img class="img-change rounded-circle mr-2" src="{{ URL::asset($item->photo ?? '') }}" alt="">
                            </a>
                            <!--</div>-->
                            <!--<div class="col-lg-7 col-6 post-header-bar">-->
                            <?php
                            ...
                            <div class="inner_img_name">
                                ...
                                <p class="post-section-artist-p2 light-gray-color">{{ $item->about }} <i class="fa fa-globe" aria-hidden="true"></i></p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-3">
                            <p class="float-right mt-2 light-gray-color text-right">{{ $category }}</p>
            ...
            <div class="col-lg-12 col-12 padding-n parent-for-video">
                @if ($item->type == 1)
                    @if (isset($item->audio_cover_image))
                        ...
                        <br>
                    @endif
                    <audio controlsList="nodownload" class="overlay-for-audio" style="width: 100%;" controls="" data-video="{{ $checkvideo }}" data-brand="{{ $item->brand }}" data-videoid="{{ $item->song_id }}" data-userid="{{ $item->artist_id }}" data-promotionid = "">
                        <source src="{{ asset($item->name) }}" type="audio/mpeg">
                    </audio>
                @else
                    @php 
                ...
                @if ($item->audio_cover_image)
                    <img src="{{ asset($item->audio_cover_image) }}" class="alternative-cover-image" alt="">
                @else
                    <video controlsList="nodownload" id="video{{ $item->song_id }}" src="{{ asset($item->name) }}" data-video="{{ $item->brand }}" class="video" type="video/mp4" controls playsinline></video>
                @endif
                    <div class="overlay-for-video" id="overlay{{ $item->song_id }}" data-video="{{ $checkvideo}}" data-videoid="{{ $item->song_id }}" data-brand="{{ $item->brand }}" data-userid="{{ $item->artist_id }}" data-promotion-details-id="{{ $item->promotion_details_id }}" data-reward="{{ $item->reward }}">
                        <img src="{{ asset('assets/images/play-button.svg') }}" class="rounded-circle" alt="">
                    </div>
                @endif
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="social-media-profile-wrap">
                <div class="sm-left-wrap">
                    <img src="{{ URL::asset($item->photo ?? '') }}" alt="" class="avatar-md avatar-md-cover rounded-circle">
                    <div class="sm-left-desc for_web">
                        <h2>{{ isset($item->brand) ? $item->brand : ''; }} </h2>
                        <p class="mb-2"><i class="fa fa-clock-o" aria-hidden="true"></i>{{ isset($item->about) ? $item->about : ''; }}</p>
                        <h5>Artist share price: <span class="color-white">${{ numberformat(@$item->stock_value) }} VXD </span>
                            @if ($item->change_stock > 0)
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                <span class="text-green">+ {{ numberformat(@$item->change_stock) }}%</span>
                        </h5>
                            @else
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/pink_arrow_circle_down.svg') }}">
                                <span class="text-danger">{{ signFormat(@$item->change_stock,0) }}%</span></h5>
                            @endif

                    </div>
                    <div class="sm-left-desc for_mob">
                        <h2>{{ isset($item->brand) ? $item->brand : ''; }}</h2>
                        <p><i class="fa fa-clock-o" aria-hidden="true"></i> {{ isset($item->about) ? $item->about : ''; }}</p>
                        <h5>Artist share price: <span class="color-white">${{ numberformat(@$item->stock_value) }} VXD </span>
                            @if ($item->change_stock > 0)
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                <span class="text-green">+ {{ numberformat(@$item->change_stock) }}%</span>
        ...
        <div id="sponsored-section mt-3" class="row">
            ...
            <div class="col-lg-12 col-12 text-center image_wrapper">
                <div class="image__innerwrapper">
                    ...
                    <div class="video_wrapper">
                        <iframe width="100%" height="400" src="https://www.youtube.com/embed/zD0mCBxY4sE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <!--<video id="video{{ $item->song_id }}" src="{{ asset($item->name) }}" class="video" type="video/mp4" controls playsinline></video>-->
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-12 mb-3">
