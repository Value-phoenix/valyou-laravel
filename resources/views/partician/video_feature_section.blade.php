...
{{-- comment, promote, valyou section -> start --}}
		...
		<div class="comment-body w-full" >
			...
			<div class="">
				...
				<div class="d-flex mt-2 col-12">
					<div>
						<img src="{{ URL::asset(auth()->user()->avatar)}}" class="avatar-md rounded-circle" style="width: 50px; height: 50px;">
					</div>
					<div style="display: inline-flex; width: 100%;">
						<input type="text" class="form-control chat-input pr-2" id="comment-input" name="comment-" placeholder="Enter Comment...">
						<img style="transform: rotate(90deg); width:50px; height:50px" id="comment-send-btn" data-media="111" src="{{URL::asset('assets/images/valyoux/green_arrow_price_going_up.svg')}}">
					</div>
				</div>
			</div>
