    ...
    public function loadmore() {
        ...
        if (!empty($artists)) {
            ...
            foreach ($artists as $key => $a) {
                ...
                $html .= '<p class="text-muted mb-0 music-title text-capitalize" sytle="font-size: 14px;!important font-family: Roboto,sans-serif;">' . $a->about . '</p></div>';
                $html .= '</td>';
                ...
                $html .= '</td>';
                $html .= '<td  style="width: 10%; font-size: 16px;" class="text-color-change">' . $stock_value . '</td>';
            ...
            foreach ($artists as $key2 => $a) {
                ...
                $html2 .= '<p class="stock-price mb-0 text-color-change stock_value_" id="'.$a->id.'"><a onclick="changeValue('.$a->id.',1)" style="font-size: 16px;">'.$stock_value.'</a></p></div>';
            	...
            	$html2 .= '<p class="text-muted music-title text-capitalize" sytle="font-size: 14px;!important font-family: Roboto,sans-serif;">' . $a->about . '</p>';
                $html2 .= '</td>';
            ...
            foreach ($artists as $key3 => $a) {
                ...
                $html3 .= '<p class="text-muted mb-0 music-title" sytle="font-size: 14px;!important font-family: Roboto,sans-serif;">' . $a->about . '</p></div>';
                $html3 .= '</td>';
