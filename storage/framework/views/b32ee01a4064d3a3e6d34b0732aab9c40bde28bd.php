                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="pt-4">
                                ...
                                <div class="mt-4 row">
                                    <div class="col-6">
                                    <a href="<?php echo e(url('contacts-profile')); ?>" class="btn-green waves-effect waves-light btn-sm" style="width: auto;">View Profile <i class="mdi mdi-arrow-right ml-1"></i></a>
                                    </div>
                                    <div class="col-6">
                                    <a href="<?php echo e(url('contacts-edit-profile')); ?>" class="btn-pink waves-effect waves-light btn-sm" style="width: auto;">Edit Profile <i class="mdi mdi-arrow-right ml-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if(!empty(auth()->user()->country)){
                                            $country=DB::table('country')->where(['cnt_code'=>auth()->user()->country])->first();
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/artist/photos.blade.php ENDPATH**/ ?>