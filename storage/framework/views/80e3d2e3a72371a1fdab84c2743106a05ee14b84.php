        ...
        <div class="card-body bg-black">
            <div class="row">
                <div class="col-3 col-md-1 col-lg-1 col-sm-1 justify-content-center d-flex">
                    <img src="<?php echo e(isset($profile) ? asset($profile) : asset('/assets/images/users/avatar-1.jpg')); ?>" alt="" class="rounded-circle img-change" >

                </div>
                <div class="col-5 col-md-3 col-lg-3 col-sm-3">
                    <div class="text-muted">
                        <h4><?php echo e($brand); ?></h4>
                        <p class="mb-1"><?php echo e($about); ?></p>
              ...
              <?php if($artist->user_id != Auth()->user()->id){ ?>
                    <button id="<?php echo e($artist_id); ?>" style="display: <?php echo e($style1); ?>" follower_id="<?php echo e($follow_id); ?>" class="btn btn-light waves-effect bottom mt-4 following">Following</button>
                     <button id="<?php echo e($artist_id); ?>" style="display:<?php echo e($style2); ?>" class="btn btn-light waves-effect bottom mt-4 follow">Follow</button>
              <?php } ?>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/layouts/profile-box.blade.php ENDPATH**/ ?>