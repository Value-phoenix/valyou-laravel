    ...
    <div class="card margin-n">
        <div class="post-section card-body">
                ...
                <div class="col-lg-12 col-12">
                    <div class="row">
                        <div class="col-lg-9 col-9 profile_img_name">
                            <a href="artist/posts/<?php echo e($item->artist['id']); ?>">
                                <img class="img-change rounded-circle mr-2" src="<?php echo e(URL::asset($item->artist->photo ?? '')); ?>" alt="">
                            </a>
                            <!--</div>-->
                            ...
                            <div class="inner_img_name">
                                <a href="artist/posts/<?php echo e($item->artist['id']); ?>">
                                    <p class="post-section-artist-p1 only_name mb-2"> <?php echo e($brand); ?></p>
                                </a>
            ...
            <div class="col-lg-12 col-12 padding-n mt-3">
                <?php if($item->type == 1): ?>
                    <p class="post-section-para"><?php echo e($item->description ?? ''); ?></p>
                <?php else: ?>
                    <a href="socialmedia/details/<?php echo e($item->id); ?>">
                        <p class="post-section-para"><?php echo e($item->description ?? ''); ?></p>
                    </a>
                <?php endif; ?>
            </div>
            <div class="col-lg-12 col-12 padding-n parent-for-video">
                <?php if($item->type == 1): ?>
                    <?php if(isset($item->audio_cover_image)): ?>
                        <div class="" style="display: flex;align-items:center;">
                            <img class="audio-cover-image" src="<?php echo e(asset($item->audio_cover_image)); ?>">
                            <p class="post-section-para audio-text">
                                <?php echo e($item->audio_title ?? ''); ?> <span><?php echo e($item->singer ?? ''); ?>, <?php echo e($item->music_by ?? ''); ?>, <?php echo e($item->starcast ?? ''); ?>

                                    <!-- <a href="socialmedia/details/<?php echo e($item->id); ?>">View More Details</a></span> -->
                            </p>
                        </div>
                        <br>
                <?php endif; ?>
                    <audio controlsList="nodownload" class="overlay-for-audio" style="width: 100%;" controls="" data-video="<?php echo e($checkvideo); ?>" data-brand="<?php echo e($item->artist->brand); ?>" data-videoid="<?php echo e($item->id); ?>" data-userid="<?php echo e($item->artist['id']); ?>">
                        <source src="<?php echo e(asset($item->name)); ?>" type="audio/mpeg">
                    </audio>
                <?php else: ?>
                    <?php
                        $checkvideo = checkVideo($item->id);
                    // print_r($item->audio_cover_image?'fox':'mon');
                    ?>

                <?php if($item->audio_cover_image): ?>
                    <img src="<?php echo e(asset($item->audio_cover_image)); ?>" class="alternative-cover-image" alt="">
                <?php else: ?>
                    <video controlsList="nodownload" id="video<?php echo e($item->id); ?>" src="<?php echo e(asset($item->name)); ?>" data-video="<?php echo e($item->artist->brand); ?>" class="video" type="video/mp4" controls playsinline></video>
                <?php endif; ?>
                    <div class="overlay-for-video" id="overlay<?php echo e($item->id); ?>" data-video="<?php echo e($checkvideo); ?>" data-videoid="<?php echo e($item->id); ?>" data-brand="<?php echo e($item->artist->brand); ?>" data-userid="<?php echo e($item->artist['id']); ?>">
            ...
            <div class="social-media-profile-wrap">
                <div class="sm-left-wrap">
                    ...
                    <div class="sm-left-desc for_web">
                        ...
                        <p class="mb-2"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo e(isset($item->artist->about) ? $item->artist->about : ''); ?></p>
                ...
                <div class="sm-right-wrap">
                    <button type="button" class="btn-invest-pink-grad" onclick="location.href='artist/profile/<?php echo e(isset($item->artist->id) ? $item->artist->id : ''); ?>'"> Invest in
                        Artist</button>
                </div>
            </div>
        </div>
    </div>
    <div style="display: none;" id="valyou-music-section-<?php echo e($item->id); ?>" class="valyou-media">
            ...
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-valyou-music" data-valyouid="<?php echo e($item->id); ?>">
                    <div class="card-body body-p">
                        <img class="mb-2 share-box-image" src="<?php echo e(asset('assets/images/valyoux/valyousongiconnew@2x.png')); ?>" style="width: 40px; height: 40px;">
            ...
            <div class="container">
                ...
                <div class="row card">
                    ...
                    <div class="mb-3">
                        ...
                        <!-- <div id="email<?php echo e($item->id); ?>" class="col-12 email">
                            <h2 class="fw-600">Promote via Email</h2>
                            <input id="promoteemail<?php echo e($item->id); ?>" type="text" data-role="tagsinput" placeholder="Please enter Multi Emails using  , " class="form-control" />
                        </div> -->
                        <!-- <div id="phone<?php echo e($item->id); ?>" class="col-12 phone">
                            <h2 class="fw-600">Promote Via SMS</h2>
                            <input id="promotephone<?php echo e($item->id); ?>" class="form-control number-input-music" placeholder="Please enter Multi Phone Numbers using  , " type="number" data-role="tagsinput">
                        </div> -->
...
<div class="<?php echo e(isset($display_ad)? 'row mb-5': ''); ?>"></div>

<!--banner Ad Backuped-->
<div class="card <?php echo e(isset($display_ad)? $display_ad: ''); ?>">
    <div class="card-body">
...
<!--video Ad Backuped-->
<div class="card videoAd_card <?php echo e(isset($display_ad)? $display_ad: ''); ?>">
    <div class="card-body">
        <div id="sponsored-section mt-3" class="row">
            <div class="col-lg-12 col-12 mt-3">
...
<!-- Play To Earn -->
<?php else: ?>
<div class="social-post <?php echo e($item->song_id); ?>">
    <div class="card margin-n">
        <div class="post-section card-body">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="row">
                        <div class="col-lg-9 col-9 profile_img_name">
                            <a href="artist/posts/<?php echo e($item->artist_id); ?>">
                                <img class="img-change rounded-circle mr-2" src="<?php echo e(URL::asset($item->photo ?? '')); ?>" alt="">
                            </a>
                            <!--</div>-->
                            <!--<div class="col-lg-7 col-6 post-header-bar">-->
                            <?php
                                ...
                                if ($item->song_id > 0) {
                                    ...
                                    $full_name = $c_user->first_name . ' ' . $c_user->last_name;
                                    $brand = $full_name . ' shared ' .  $item->brand . ' video';
                                } else {
                                    $brand = $item->brand;
                                }
                            ?>
                            <div class="inner_img_name">
                                ...
                                <p class="post-section-artist-p2 light-gray-color"><?php echo e($item->about); ?> <i class="fa fa-globe" aria-hidden="true"></i></p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-3">
                            <p class="float-right mt-2 light-gray-color text-right"><?php echo e($category); ?></p>
            ...
            <div class="col-lg-12 col-12 padding-n mt-3">
                <?php if($item->type == 1): ?> 
                    <p class="post-section-para"><?php echo e($item->description ?? ''); ?></p>
                <?php else: ?>
                    <a href="socialmedia/details/<?php echo e($item->song_id); ?>">
                        <p class="post-section-para"><?php echo e($item->description ?? ''); ?></p>
                    </a>
                <?php endif; ?>
            </div>
            <div class="col-lg-12 col-12 padding-n parent-for-video">
                        ...
                        <div class="" style="display: flex;align-items:center;">
                            ...
                            <p class="post-section-para audio-text">
                                <?php echo e($item->audio_title ?? ''); ?> <span><?php echo e($item->singer ?? ''); ?>, <?php echo e($item->music_by ?? ''); ?>, <?php echo e($item->starcast ?? ''); ?>
                                    ...
                                    <!-- <a href="socialmedia/details/<?php echo e($item->song_id); ?>">View More Details</a></span> -->
                            </p>
                        </div>
                        <br>
                    <?php endif; ?>
                    <audio controlsList="nodownload" class="overlay-for-audio" style="width: 100%;" controls="" data-video="<?php echo e($checkvideo); ?>" data-brand="<?php echo e($item->brand); ?>" data-videoid="<?php echo e($item->song_id); ?>" data-userid="<?php echo e($item->artist_id); ?>" data-promotionid = "">
                        <source src="<?php echo e(asset($item->name)); ?>" type="audio/mpeg">
                    </audio>
                <?php else: ?>
                    <?php 
                ...
                <?php if($item->audio_cover_image): ?>
                    <img src="<?php echo e(asset($item->audio_cover_image)); ?>" class="alternative-cover-image" alt="">
                <?php else: ?>
                    <video controlsList="nodownload" id="video<?php echo e($item->song_id); ?>" src="<?php echo e(asset($item->name)); ?>" data-video="<?php echo e($item->brand); ?>" class="video" type="video/mp4" controls playsinline></video>
                <?php endif; ?>
                    <div class="overlay-for-video" id="overlay<?php echo e($item->song_id); ?>" data-video="<?php echo e($checkvideo); ?>" data-videoid="<?php echo e($item->song_id); ?>" data-brand="<?php echo e($item->brand); ?>" data-userid="<?php echo e($item->artist_id); ?>" data-promotion-details-id="<?php echo e($item->promotion_details_id); ?>" data-reward="<?php echo e($item->reward); ?>">
                        <img src="<?php echo e(asset('assets/images/play-button.svg')); ?>" class="rounded-circle" alt="">
                    </div>
                <?php endif; ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="social-media-profile-wrap">
                <div class="sm-left-wrap">
                    <img src="<?php echo e(URL::asset($item->photo ?? '')); ?>" alt="" class="avatar-md avatar-md-cover rounded-circle">
                    <div class="sm-left-desc for_web">
                        <h2><?php echo e(isset($item->brand) ? $item->brand : ''); ?> </h2>
                        <p class="mb-2"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo e(isset($item->about) ? $item->about : ''); ?></p>
                        <h5>Artist share price: <span class="color-white">$<?php echo e(numberformat(@$item->stock_value)); ?> VXD </span>
                            <?php if($item->change_stock > 0): ?>
                                <img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>">
                                <span class="text-green">+ <?php echo e(numberformat(@$item->change_stock)); ?>%</span>
                        </h5>
                            <?php else: ?>
                                <img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/pink_arrow_circle_down.svg')); ?>">
                                <span class="text-danger"><?php echo e(signFormat(@$item->change_stock,0)); ?>%</span></h5>
                            <?php endif; ?>

                    </div>
                    <div class="sm-left-desc for_mob">
                        <h2><?php echo e(isset($item->brand) ? $item->brand : ''); ?></h2>
                        <p><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo e(isset($item->about) ? $item->about : ''); ?></p>
                        <h5>Artist share price: <span class="color-white">$<?php echo e(numberformat(@$item->stock_value)); ?> VXD </span>
                            <?php if($item->change_stock > 0): ?>
                                <img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>">
                                <span class="text-green">+ <?php echo e(numberformat(@$item->change_stock)); ?>%</span>
                ...
                <div class="sm-right-wrap">
                    <button type="button" class="btn-invest-pink-grad" onclick="location.href='artist/profile/<?php echo e(isset($item->artist_id) ? $item->artist_id : ''); ?>'"> Invest in
                        Artist</button>
                </div>
            </div>
        </div>
    </div>
    <div style="display: none;" id="valyou-music-section-<?php echo e($item->song_id); ?>" class="valyou-media">
        <!-- <button type="button" class="close" data-dismiss="modal" style="padding: 1rem; padding-top: 0; margin: -1rem -1rem -1rem auto; font-size: 2rem; font-weight: 700;  line-height: 1; text-shadow: 0 1px 0 #fff; opacity: .5;">
                        <span>×</span>
                    </button> -->
        <div class="container">
            ...
            <div class="container col-md-12 text-center mb-5 proceed-valyou-song-div">
                <p class="text-danger error_message">Please choose an option above</p>
                <button type="button" class="btn valyou-g-btn add_value spycust-margin-10" value="<?php echo e($item->song_id); ?>">Proceed to Valyou Song</button>
                <button type="button" class="btn valyou-close-btn spycust-margin-10" value="<?php echo e($item->song_id); ?>">Cancel</button>
    ...
    <div class="container mb-3 mt-3 added-feature">
        <div class="row ">
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-valyou-music" data-valyouid="<?php echo e($item->song_id); ?>">
                    <div class="card-body body-p">
            ...
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-comments" data-commentid="<?php echo e($item->song_id); ?>">
                    <div class="card-body body-p">
                        <img class="mb-2 share-box-image" src="<?php echo e(asset('assets/images/comments.svg')); ?>">
                        <p class="card-text mobile-v">Comments</p>
                    </div>
            ...
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-promote-song" data-promoteid="<?php echo e($item->song_id); ?>">
                    <div class="card-body body-p">
                        <img class="mb-2 share-box-image" src="<?php echo e(asset('assets/images/promote.svg')); ?>">
                        <p class="card-text mobile-v">Promote</p>
                    </div>
    ...
    <div style="display: none" class="mt-3" id="comments-section-<?php echo e($item->song_id); ?>">
        <div class="w-100 user-chat">
            <div class="card">
                <div class="col-md-12 container">
                    <ul class="list-unstyled mt-3" data-simplebar style="max-height: 470px;">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-8 mt-3 mt-0-mobile col-8 pad-left-0">
                            <div class="position-relative">
                                <input type="text" class="form-control chat-input" name="comment-<?php echo e($item->song_id); ?>" placeholder="Enter Comment...">
                            </div>
                        </div>

                        <div class="col-md-2 col-2">

                            <img style="transform: rotate(90deg);" class="mr-3 comment-btn" data-media="<?php echo e($item->song_id); ?>" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form method="post" action="<?php echo e(url('promotevideo/'.$item->song_id)); ?>" id="promotevideo-form-<?php echo e($item->song_id); ?>">
        <?php echo csrf_field(); ?>
        <div style="display: none" id="promote-song-section-<?php echo e($item->song_id); ?>">
            <div class="container">
                <!-- Set Promotion Budget -->
                <div class="row card">
                    <div class="modal-header">
                        <h5 class="modal-title">Invite your friends, new fans & potential investors to listen to your song</h5>
                        <button type="button" class="btn-close close-btn-promote-song-section" data-bs-dismiss="modal" data-promoteid="<?php echo e($item->song_id); ?>" aria-label="Close"></button>
                    </div>
                    <div class="card-body price-card mb-5 text-center">
                        <div class="row">
                            <div class="col-md-3"></div>
                        ...
                        <div class="quantity">
                            <input type='button' value='-' id="minus" class='minus' field='quantity' />
                            <span class="input-qty pt-3"></span>
                            <input type='text' id="quantity<?php echo e($item->song_id); ?>" name='quantity' value='50' class='qty input-qty dollar' />
                            <input type='button' value='+' id="plus" class='plus ' field='quantity' />
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 text-center mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <input type='button' value='-' class='minus' id="minus2" field='quantity2' />
                                <span class="input-qty pt-3"></span>
                                <input type='text' id="quantity2<?php echo e($item->song_id); ?>" name='quantity2' value='2' class='qty input-qty pt-3' />
                                <input type='button' value='+' class='plus ' id="plus2" field='quantity2' />
                                <p class="card-text">In that case you want to spend $50 budget.<br>If you pay each listener $2, you can reach 25 people.<br>
                                    Else you pay one listener $50, you can reach 1 person.<br>To reach more people Increase your budget or reduce the amount you would like to pay each listener</p>
                            </div>
                    ...
                    <!-- Set investors, invitations emails, Phone numbers -->
                    <div class="mb-3">
                        <div id="valyoux<?php echo e($item->song_id); ?>" class="col-12 valyoux users-list">
                            <h2 class="fw-600">Investors on Valyou X </h2>
                            <input name='investor-list'id="investorlist<?php echo e($item->song_id); ?>" value='abatisse2@nih.gov, Justinian Hattersley'  class='tagify--outside'>
                        </div>
                        <!-- <div id="email<?php echo e($item->song_id); ?>" class="col-12 email">
                            <h2 class="fw-600">Promote via Email</h2>
                            <input id="promoteemail<?php echo e($item->song_id); ?>" type="text" data-role="tagsinput" placeholder="Please enter Multi Emails using  , " class="form-control" />
                        </div> -->
                        <!-- <div id="phone<?php echo e($item->song_id); ?>" class="col-12 phone">
                            <h2 class="fw-600">Promote Via SMS</h2>
                            <input id="promotephone<?php echo e($item->song_id); ?>" class="form-control number-input-music" placeholder="Please enter Multi Phone Numbers using  , " type="number" data-role="tagsinput">
                        </div> -->
                        
                        <div id="email<?php echo e($item->song_id); ?>" class="col-12">
                            <h2 class="fw-600">Promote via Email</h2>
                            <input name='email-promote' id="promoteemail<?php echo e($item->song_id); ?>" class='tagify--outside' placeholder='Please enter Multi Emails'>
                        </div>

                        <div id="email<?php echo e($item->song_id); ?>" class="col-12">
                            <h2 class="fw-600">Promote via SMS</h2>
                            <input id="phone<?php echo e($item->song_id); ?>" type="tel" name="phone-promote" data-id="<?php echo e($item->song_id); ?>" class="form-control" />
                            <div class="mb-2"></div>
                            <input name='sms-promote' id="promotephone<?php echo e($item->song_id); ?>" class='tagify--outside tagify--outside-sms' placeholder='Please enter Multi SMS'>
                        </div>
                    </div>
                    <div class="col-md-12 mb-2">
                        <button type="button" class="btn post-now-btn float-right mb-3 promote-btn-<?php echo e($item->song_id); ?>" onclick="promoteVideo('<?php echo e($item->song_id); ?>')"> Promote </button>
                    </div>
                </div>
        ...
        <div id="sponsored-section mt-3" class="row">
            ...
            <div class="col-lg-12 col-12 text-center image_wrapper">
                <div class="image__innerwrapper">
                    ...
                    <div class="video_wrapper">
                        <iframe width="100%" height="400" src="https://www.youtube.com/embed/zD0mCBxY4sE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <!--<video id="video<?php echo e($item->song_id); ?>" src="<?php echo e(asset($item->name)); ?>" class="video" type="video/mp4" controls playsinline></video>-->
                    </div>
                </div>
            </div>
            <div class="col-lg-12 col-12 mb-3">
...
<?php $__env->stopSection(); ?>
<?php /**PATH D:\@hbs@\git repository\valyou-laravel\resources\views/partician/all_videos.blade.php ENDPATH**/ ?>