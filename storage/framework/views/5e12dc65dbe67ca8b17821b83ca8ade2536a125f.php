                ...
                <div class="col-sm-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?php echo e(asset('/assets/images/bank/artist_icon.svg')); ?>" alt="" class="bank-item-svg" >
                                </div>
                                <div class="media-body">
                ...
                <div class="col-sm-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?php echo e(asset('/assets/images/bank/investor_icon.svg')); ?>" alt="" class="bank-item-svg" >
                                </div>
                                <div class="media-body">
                ...
                <div class="col-sm-4">
                    <div class="card mini-stats-wid">
                        <div class="card-body">
                            <div class="media">
                                <div class="mr-3 align-self-center">
                                    <img src="<?php echo e(asset('/assets/images/bank/business_icon.svg')); ?>" alt="" class="bank-item-svg" >
                                </div>
                                <div class="media-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/artist/bank.blade.php ENDPATH**/ ?>