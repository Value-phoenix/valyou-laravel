                ...
                <div class="card-body">
                    <div class="float-right">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission_create')): ?>
                            <a class="btn btn-v-green" href="<?php echo e(url(request()->segment(1).'/form/add')); ?>">Add</a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\valyoux_backend\resources\views/admin/permission/list.blade.php ENDPATH**/ ?>