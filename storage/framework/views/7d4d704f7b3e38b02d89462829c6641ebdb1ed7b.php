...
<body>
    ...
    <div class="row logo-div justify-between align-center">
        ...
        <div class="mr-5 d-flex gap-2">
            <a class="btn btn-outline-success exchange bg-hoverevent py-2 logbtns" href="<?php echo e(url('/login')); ?>" style="border-color: rgb(250, 132, 152);font-size: 15px;color: rgb(250, 132, 152);">Login/sign up</a>
            <a class="btn btn-token-presale exchange text-hoverevent py-2 logbtns" href="<?php echo e(url('/presell')); ?>">TOKEN
                PRESALE</a>
            <div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\@hbs@\git repository\valyou-laravel\resources\views/home.blade.php ENDPATH**/ ?>