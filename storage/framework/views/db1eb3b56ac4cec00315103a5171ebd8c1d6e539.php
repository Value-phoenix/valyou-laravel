...
/* * {
	...
	.project-list-table {
            ...
            border-spacing: 4px 12px !important;
			width: 100% !important;
	}
	.project-list-table tr {
                        ...
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <div class="text-muted">
                                    <h4 class="mb-1  md:small" style="font-family: 'Roboto', sans-serif; color: #ffffff; font-weight:500;  "><?php echo e(Auth::user()->first_name.' '.Auth::user()->last_name); ?></h4>
    ...
    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        ...
        <div>
            ...
            <ul class="nav nav-pills py-3 overflow-auto">
                ...
                <li class="nav-item ">
                    <a class="nav-link px-2 w-full text-center song-type <?php echo e($key==0?'active': ''); ?>" data-toggle="pill" href="#home" style="background-color: rgb(243 244 246); font-family: 'Roboto',sans-serif; font-style: normal; -webkit-transform: translateZ(0);">&nbsp;&nbsp;<?php echo e($item); ?>&nbsp;&nbsp;</a>
                </li>
        ...
        <div class="tab-content" >
            <div class="tab-pane container active" id="home" style="max-width:100%; padding: 0">
			...
			<div class="tab-content" id="watchTabContent" ">
				<div class="tab-pane fade active show" id="nav-watch" role="tabpanel" aria-labelledby="nav-watch-tab" style="display: block">
							...
							<div class="inner-button-part">
								<div class="personal-detail-info">
									<div class="personal-img">			
										<img src="<?php echo e(URL::asset('assets/uploads/artist/72921766.jpg')); ?>" style="width: 48px;" alt="">
								...
								<div class="left-btn">
										<div class="text-center">
							              <div class="btn-text css-hrnnei left-card-part share-comments mo-comment-btn" data-commentid="111">
								           <p class="comments card-text text-comments" style="display: inline-flex"> <span class="mt-1"><img class="hint-img" src="<?php echo e(URL::asset('assets/images/comments.svg')); ?>" style="width: 50%"></span><span class="mt-1 " style="font-weight: 600;"> COMMENTS</span> </p>
							             </div>
						               </div>
						              <div class="btn-text text-center mx-2">
							           <div class="css-hrnnei left-card-part share-promote-song mo-promote-btn" data-promoteid="111">
								        <p class="promote card-text text-promote" style="display: inline-flex"><span><img class="hint-img" src="<?php echo e(URL::asset('assets/images/promote.svg')); ?>" alt="" style="width: 50%"></span><span class="mt-1 " style="font-weight: 600;">PROMOTE</span></p>
							          </div>
						            </div>
									</div>
									<!-- <div class="left-btn">
							...
							<p class="text-2xl font-[800]" style="font-weight:800; font-size: 1.5rem; line-height:2rm; font-family: 'Roboto', sans-serif; font-style:normal; color:#050f3f;">All Videos</p>
								...
								<div class="especailly-part" style="background:#ffffff; box-shadow: 0px 0px 9.3758px rgba(0,0,0,0.1); border-radius:10px; margin:10px; display:flex; padding:12px">
									...
									<div class="video-detail-info">
										<p style="font-size: large"><?php echo e(@$row->audio_title); ?></p>
										<p><?php echo e(@$row->singer); ?></p>
										<p>Song Valyou: <strong id="valyou-val">$<?php echo e(numberformat(@$row->artist->stock_value)); ?></strong></p>
										<p>Stock Price &nbsp;<span></span>&nbsp;<strong class="<?php echo e((@$row->artist->stock_value < 0) ?'c-pink': 'c-green'); ?>"><img class="" width="15" height="15" src="<?php echo e((@$row->artist->stock_value < 0) ?'https://testvps.nwlogics.com/public/assets/images/valyoux/pink_arrow_circle_down.svg': 'https://testvps.nwlogics.com/public/assets/images/valyoux/green_arrow_price_going_up.svg'); ?>">&nbsp;$<?php echo e(numberformat(@$row->artist->stock_value)); ?></strong>&nbsp; - &nbsp;<strong class="<?php echo e((@$row->artist->change_stock < 0) ?'c-pink': 'c-green'); ?>"><?php echo e($row->artist->change_stock); ?>%</strong></p>
									</div>
								</div>		
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<div class="promote-main-body p-3">
									<div class="promote-comment-part">
										<div class="comment-logo-part"  >
											<!-- <img src="<?php echo e(URL::to('/assets/uploads/artist/72921766.jpg')); ?>" style="width: 48px; height: 48px" alt=""> -->
											<div class="comment-logo-detail-info">
												<p class="py-auto"><strong>Prompte</strong></p>
											</div>
										</div>	
										<div class="close-promote">
											<!-- <img src="<?php echo e(URL::to('/assets/images/close_btn.png')); ?>" class="close_btn" alt="close"> -->
					...
					<div class="personal-info-button-part desktop-detail-info" style="margin-bottom: 10px;">
						...
						<div class="personal-detail-info">
							<div class="personal-img">			
								<img src="<?php echo e(asset($artists[0]->photo)); ?>" style="width: 48px;" alt="">	
							</div>
						...
						<div class="special-video-part " >
							...
							<div class="especailly-part inline-flex w-full" onclick="selVideoDetail(<?php echo e($row->id); ?>, 1)">
								...
								<div class="video-detail-info py-1 pl-2 d-flex">
									<div class="m-auto">
										<p class="fs-2 font-weight-400 py-2" style="font-weight:400; font-size:1rem; line-height: 1.5rem; font-family: 'Roboto', sans-serif; color:#050f3f;"><?php echo e(@$row->singer); ?> - <?php echo e(@$row->audio_title); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/valyou-playlist.blade.php ENDPATH**/ ?>