...
<!-- Left Sidebar End -->
<form id="logoutform" action="<?php echo e(route('logout')); ?>" style="display: none" method="POST"><?php echo csrf_field(); ?></form><?php /**PATH D:\@hbs@\git repository\valyou-laravel\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>