            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect mr-1">
                        <img class="mr-1" width="25" src="<?php echo e(asset('assets/images/valyoux/artist_icon.svg')); ?>" style="padding-top:0.75rem;padding-bottom:0.75rem;">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <img class="mr-1" width="25" src="<?php echo e(asset('assets/images/valyoux/stockmarket_icon.svg')); ?>" style="padding-top:0.75rem;padding-bottom:0.75rem;">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span style="font-weight:500;font-size:16px;position: padding-top:0.75rem;padding-bottom:0.75rem;"><?php echo app('translator')->get('translation.Authentication'); ?></span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
...
</script><?php /**PATH D:\@hbs@\git repository\valyou-laravel\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>