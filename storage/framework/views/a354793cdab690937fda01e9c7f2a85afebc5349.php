        ...
        <div class="row mt-2 " style="margin-left: 10px !important">
            <div class="col-md-12 col-lg-7 px-0" >
				...
				<div class="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root border  css-1ccbh2c">
					<div class="MuiCardContent-root !pb-[16px] css-zugfr9" style="padding: 2% 0 !important">
						<div class="d-flex items-center justify-between" style="padding-top: 2%;">
							<div class="d-flex items-center px-2">
								...
								<div class="flex-col items-center px-2">
									...
									<p class="text-xs" style="font-size: 0.75rem; line-height: 1rem; margin-bottom: 0px !important;"><span style="color: rgb(209 213 219); margin-right: 1px;">Rapper</span style="color: #050f3f;"><span>shared video track</span></p>
								</div>
							</div>
							<div class="d-flex px-2">
								<p style="font-weight: 400;  color:#050f3f;">Major Artist</p>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="uploading-section-artist card p-4 " style="width: fit-content">
                    <div class="d-inline-flex">
                        ...
                        <div class="align-self-end ml-auto">
                            <span class="up-change-stock text-green fs-2 hand mr-5">up &nbsp<img class="" width="15" height="15" src="https://testvps.nwlogics.com/public/assets/images/valyoux/green_arrow_price_going_up.svg"></span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/social-media.blade.php ENDPATH**/ ?>