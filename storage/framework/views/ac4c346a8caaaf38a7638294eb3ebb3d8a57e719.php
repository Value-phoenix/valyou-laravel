            ...
            <div class="card plan-box _1JscEqX4">
                <div class="card-body p-4">
                    ...
                    <div class="text-center plan-btn">
                        <a href="<?php echo e(url('crypto-buy-sell')); ?>" class="btn btn-black btn-sm waves-effect waves-light">Sign up Now</a>
                    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card plan-box black">
                <div class="card-body p-4">
                    ...
                    <div class="text-center plan-btn">
                        <a href="<?php echo e(url('crypto-buy-sell')); ?>" class="btn btn-success btn-sm waves-effect waves-light">Sign up Now</a>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\@hbs@\git repository\valyou-laravel\resources\views/artist/investment_deal.blade.php ENDPATH**/ ?>