<?php $__env->startSection('title'); ?> Investment-portfolio <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('common-components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Portfolio / Dividends <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_1'); ?> Crypto <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_2'); ?> Lending <?php $__env->endSlot(); ?>
            ...
            <div class="card">
                <div class="card-body border-bottom">
                    ...
                    <div>
                        ...
                        <div>
                            <h5 class=""><?php echo e(auth()->user()->first_name.' '.auth()->user()->last_name); ?></h5>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div>
                                    ...
                                    <h2 class="roboto-bold">$<?php echo e(numberformat($total_stock)); ?> VXD</h2>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-xs mr-3">
                                        <span class="avatar-title rounded-circle bg-soft-info text-info font-size-18">
                                            <img src="<?php echo e(asset('assets/images/valyoux/valyoux_mascot_white.svg')); ?>" width="20" height="20">
                                        </span>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\@hbs@\git repository\valyou-laravel\resources\views/bank/investment-portfolio.blade.php ENDPATH**/ ?>