...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card overflow-hidden">
                <div class="bg-soft-primary bg-black">
                    <div class="row">
                        <div class="col-7">
                            <div class="text-primary p-3">
                                <h5 class="text-primary">Welcome Back !</h5>
                                <p>Valyou X Dashboard</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg')); ?>"
                                    alt="" class="img-thumbnail rounded-circle user-avatar">
                            </div>
                            <h5 class="font-size-15 text-truncate"><?php echo e(Auth::user()->name); ?></h5>
                            <p class="text-muted mb-0 text-truncate">Company</p>
                        </div>
        ...
        <div class="col-xl-12">
            <div class="row">
                ...
                <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Currency Exchange <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> 
                        <?php if(isset($setting)): ?>
                            <?php echo e($setting->usdc_to_vxd); ?>
                ...
                <?php $__env->startComponent('common-components.index-widget'); ?>
                    ...
                    <?php $__env->slot('icon'); ?> bx bx-archive-in font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
                ...
                <?php $__env->startComponent('common-components.index-widget'); ?>
                    ...
                    <?php $__env->slot('price'); ?>
                    <?php if(isset($setting)): ?>
                     <?php echo e($setting->market_maker_price); ?>

                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>

            </div>
        	<!-- <button class="btn btn-primary waves-effect waves-light btn-sm" id='view_more' style="float:right;">View More</button>
         -->
        <div class="row" style="margin-top:2.5rem;" id="show_more_revenue">

                <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Sell Stock Revenue <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> 
                    <?php if(isset($revenueDetail)): ?>
                    $ <?php echo e($revenueDetail->sell_stock); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-copy-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
                ...
                <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Buy Stock Revenue <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?>
                    <?php if(isset($revenueDetail)): ?>
                    $ <?php echo e($revenueDetail->buy_stock); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-archive-in font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
                ...
                <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Stripe Charges <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> $ <?php echo e($revenueDetail->credit_card ?? 0); ?> <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
        
        		<?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Audio Streaming Fee <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?>
                    <?php if(isset($setting)): ?>
                    <?php echo e($setting->audio_streaming_fee); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
        		<?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Video Streaming Fee <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?>
                    <?php if(isset($setting)): ?>
                    <?php echo e($setting->video_streaming_fee); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
        <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Admin Video Streaming Fee <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> 
                    <?php if(isset($setting)): ?>
                    <?php echo e($setting->admin_video_streaming_fee); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
        <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Admin Audio Sreaming Fee <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?>
                    <?php if(isset($setting)): ?>
                    <?php echo e($setting->admin_audio_streaming_fee); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
        <?php $__env->startComponent('common-components.index-widget'); ?>
                    <?php $__env->slot('title'); ?> Advertisement Fee <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?>
                    <?php if(isset($setting)): ?>
                    <?php echo e($setting->advertisement_fee); ?> 
                    <?php endif; ?>
                    <?php $__env->endSlot(); ?>
                    <?php $__env->slot('icon'); ?> bx bx-purchase-tag-alt font-size-24 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
            ...
            <div class="card" style="margin-top:2.5rem">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">Growth Rate Users</h4>
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Top Cities With the Most User Type</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Latest Transaction - Paid / Withdrawal / Chargeback / Refunds</h4>
                        ...
                        <div class="mt-4">
                            <div class="table-responsive">
                                <table id="datatable4Token" class="datatable table table-hover dt-responsive nowrap display"
                                    ...
                                    <tbody>
                                    <?php   $i = 1; ?>
                                    <?php if(isset($AccessTokenHistory) && count($AccessTokenHistory) > 0): ?>
...
<?php $__env->startSection('script'); ?>
	...
	<script>
     ...
     //    	var viwe_more_text = $("#show_more_revenue").is(':visible');
     //    	if(viwe_more_text){
     //        	$(this).text('View More');
     //        }
     //    	else{
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/index.blade.php ENDPATH**/ ?>