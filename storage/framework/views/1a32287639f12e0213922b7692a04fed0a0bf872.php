    ...
    <div class="card margin-n">
        <div class="post-section card-body">
                ...
                <div class="col-lg-12 col-12">
                    <div class="row">
                        <div class="col-lg-9 col-9 profile_img_name">
                            <a href="artist/posts/<?php echo e($item->promotionVideos->artist_id); ?>">
                                <img class="img-change rounded-circle mr-2" src="<?php echo e(URL::asset($artist->photo ?? '')); ?>" alt="">
                            </a>
                            <!--</div>-->
                            ...
                            <div class="inner_img_name">
                                ...
                                <p class="post-section-artist-p2 light-gray-color"><?php echo e($artist->about); ?> <i class="fa fa-globe" aria-hidden="true"></i></p>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-12 padding-n mt-3">
                <?php if($item->promotionVideos->type == 1): ?> 
                    <p class="post-section-para"><?php echo e($item->promotionVideos->description ?? ''); ?></p>
                <?php else: ?>
            ...
            <div class="col-lg-12 col-12 padding-n parent-for-video">
                <?php if($item->promotionVideos->type == 1): ?>
                    <?php if(isset($item->promotionVideos->audio_cover_image)): ?>
                        <div class="" style="display: flex;align-items:center;">
                            <img class="audio-cover-image" src="<?php echo e(asset($item->promotionVideos->audio_cover_image)); ?>">
                            <p class="post-section-para audio-text">
                                <?php echo e($item->promotionVideos->audio_title ?? ''); ?> <span><?php echo e($item->promotionVideos->singer ?? ''); ?>, <?php echo e($item->promotionVideos->music_by ?? ''); ?>, <?php echo e($item->promotionVideosstarcast ?? ''); ?>
                        ...
                        <br>
                    <?php endif; ?>
                    <audio controlsList="nodownload" class="overlay-for-audio" style="width: 100%;" controls="" data-video="<?php echo e($checkvideo); ?>" data-brand="<?php echo e($artist->brand); ?>" data-videoid="<?php echo e($item->song_id); ?>" data-userid="<?php echo e($item->promotionVideos->artist_id); ?>" data-promotionid = "">
                        <source src="<?php echo e(asset($item->promotionVideos->name)); ?>" type="audio/mpeg">
                    </audio>
                <?php else: ?>
                    <?php 
                ...
                <?php if($item->promotionVideos->audio_cover_image): ?>
                    <img src="<?php echo e(asset($item->promotionVideos->audio_cover_image)); ?>" class="alternative-cover-image" alt="">
                <?php else: ?>
                    <video controlsList="nodownload" id="video<?php echo e($item->song_id); ?>" src="<?php echo e(asset($item->promotionVideos->name)); ?>" data-video="<?php echo e($artist->brand); ?>" class="video" type="video/mp4" controls playsinline></video>
                <?php endif; ?>
                    <div class="overlay-for-video" id="overlay<?php echo e($item->song_id); ?>" data-video="<?php echo e($checkvideo); ?>" data-promotion-id="<?php echo e($item->id); ?>" data-videoid="<?php echo e($item->song_id); ?>" data-brand="<?php echo e($artist->brand); ?>" data-userid="<?php echo e($item->promotionVideos->artist_id); ?>" data-promotion-details-id="<?php echo e($item->promotion_details_id); ?>" data-single-reward="<?php echo e($item->single_price); ?>" data-reward="<?php echo e($item->reward); ?>">
        ...
        <div class="col-lg-12">
            ...
            <div class="social-media-profile-wrap">
                <div class="sm-left-wrap">
                    <img src="<?php echo e(asset($artist->photo)); ?>" alt="" class="avatar-md avatar-md-cover rounded-circle">
                    <div class="sm-left-desc for_web">
                        <h2><?php echo e(isset($artist->brand) ? $artist->brand : ''); ?> </h2>
                        <p class="mb-2"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo e(isset($artist->about) ? $artist->about : ''); ?></p>
                        <h5>Artist share price: <span class="color-white">$<?php echo e(numberformat(@$artist->stock_value)); ?> VXD </span>
                            <?php if($artist->change_stock > 0): ?>
                                <img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>">
                                <span class="text-green">+ <?php echo e(numberformat(@$artist->change_stock)); ?>%</span>
                        </h5>
                            <?php else: ?>
                                <img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/pink_arrow_circle_down.svg')); ?>">
                                <span class="text-danger"><?php echo e(signFormat(@$artist->change_stock,0)); ?>%</span></h5>
                            <?php endif; ?>

                    </div>
                    <div class="sm-left-desc for_mob">
                        <h2><?php echo e(isset($artist->brand) ? $artist->brand : ''); ?></h2>
                        <p><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo e(isset($artist->about) ? $artist->about : ''); ?></p>
                        <h5>Artist share price: <span class="color-white">$<?php echo e(numberformat(@$artist->stock_value)); ?> VXD </span>
                            <?php if($artist->change_stock > 0): ?>
                                <img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>">
                                <span class="text-green">+ <?php echo e(numberformat(@$artist->change_stock)); ?>%</span>
            ...
            <div class="col-4 col-md-4 text-center padding-r ">
                <div class="card shadow-none share-valyou-music" data-valyouid="<?php echo e($item->song_id); ?>">
                    <div class="card-body body-p">
                        <img class="mb-2 share-box-image img_vlyouSong" src="<?php echo e(asset('assets/images/valyoux/valyousongiconnew@2x.png')); ?>">
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.27)\valyoux_backend\resources\views/partician/promote_videos.blade.php ENDPATH**/ ?>