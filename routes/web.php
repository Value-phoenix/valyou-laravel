...
Route::get('/presell', 'HomeController@presell')->name('presell');
Auth::routes();
...
Route::group(['namespace' => 'Admin', 'as' => 'admin.', 'middleware' => ['auth','twofactor']], static function () {
    ...
    // Route::get('social-media-biding', 'SocialmediaController@socialMedia_biding');
...
Route::view('/business-profile', 'business-profile')->name('business-profile');
...
Route::get('get-cities/{countryId}', 'CityController@getCitiesByCountryId');
//test
Route::post('/get-cities/countryId', 'CityController@getCitiesByCountryIdtest');
